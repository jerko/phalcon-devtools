...
use Phalcon\Builder\Mbit as MbitBuilder;

/**
 * Mbit Command
 *
 * Scaffold a Mbit controller, model and view for a database table
 *
 * @package     Phalcon\Commands\Builtin
 * @copyright   Copyright (c) 2011-2015 Phalcon Team (team@phalconphp.com)
 * @license     New BSD License
 */
class Mbit extends Command
{
    protected $_possibleParameters = array(
		...
		'anotheroption=s'  => "Controller's another option [optional]",
    );
    ...
    public function run($parameters)
    {
        ...
        $scaffoldBuilder = new mbitBuilder(array(
            'name'                 => $name,
            'schema'               => $schema,
    ...
    public function getHelp()
    {
        ...
        print Color::colorize('  Creates a scaffold mbit from a database table') . PHP_EOL . PHP_EOL;

        print Color::head('Usage:') . PHP_EOL;
        print Color::colorize('  mbit [tableName] [options]', Color::FG_GREEN) . PHP_EOL . PHP_EOL;
